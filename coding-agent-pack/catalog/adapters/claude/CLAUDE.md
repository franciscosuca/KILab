...
- Check whether task-specific agents or skills exist under `.claude/agents/` and `.claude/commands/`.
- If a matching agent or skill exists, suggest using it and explain why it fits the task.
