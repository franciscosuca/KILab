---
name: Model Evals Results Updater
description: "Use only when asked to update contributions/setup-fco/results.md with newly completed HumanEval runs from model-evals/logs. Computes tok/s from .eval files and appends table rows for successful runs not yet listed."
...
1. Invoke the `copilot:model-evals` skill and follow it to:
