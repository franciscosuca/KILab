---
name: copilot:model-evals
description: Gather macOS hardware info (chip, RAM) and compute tok/s results from Inspect AI .eval logs in this folder, formatted for the results.md table. Use for VS Code Copilot.
---

# Model Evals Results Skill (Copilot)
